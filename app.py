...
app.config['MYSQL_PASSWORD'] = '@Sive3908653'
app.config['MYSQL_DB'] = 'iKAMVA'
...
def logout():
    session.clear()
    flash('You are now logged logged out', 'success')
    return redirect(url_for('login'))

if __name__ == "__main__":
    app.secret_key = '@Siphelele199905'
    app.run(debug=True)
